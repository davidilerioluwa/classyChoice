  ...
  return (
    <div className="w-full gap-4 h-full pb-12 mt-20 p-4 min-h-screen">
      ...
      <form onSubmit={(e) => search(e)} className="w-full flex gap-2 mb-4 ">
        ...
        />
        <button
          className="bg-purple-900 px-2 py-1.5 rounded-md text-white text-lg md:text-3xl"
          onClick={() => setShowSearch(true)}
        >
          <HiAdjustmentsHorizontal />
        </button>
        <button
          className="bg-purple-900 px-2 py-1.5 rounded-md text-white"
          type="submit"
        >
          Search
        </button>
      ...
      <SearchTags />
      <p
        className="border border-purple-800  px-4 my-2 py-2 w-fit rounded-md bg-purple-900 text-white hover:underline cursor-pointer "

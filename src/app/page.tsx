...
return (
  <div className=''>
    <section className='w-screen h-fit md:h-screen mt-14 relative md:grid grid-cols-12 justify-between bg-purple-800'>
      ...
      <div className='absolute top-32 bg-purple-900 backdrop-blur-sm mx-8 md:hidden rounded-md bg-opacity-80 p-8 py-18 z-10 flex flex-col col-span-7 gap-2 md:gap-4 justify-center items-start text-white'>

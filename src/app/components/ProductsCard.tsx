...
const ProductsCard = ({
  ...
  const getButtonText = () => {
    ...
    if (disableAdd && snap.user?._id) return "Added To Cart";
    return "Add to Cart";
  };
  ...
  return (
    <div
      className={`bg-white drop-shadow-md p-3 rounded-md  md:flex flex-col gap-0.5 cursor-pointer `}
    >
        ...
        >
          ...
          {showEditMenu ? (
            <div className="absolute text-purple-900 w-full bg-white drop-shadow-lg rounded-md p-2 flex flex-col gap-1 top-[-65px]">
              <button
                className="bg-white p-1 rounded-md hover:drop-shadow-lg"
                onClick={() => {
              ...
              <button
                className="bg-white rounded-md p-1 hover:drop-shadow-lg"
                onClick={() => {

...
const PaymentDetails = ({
  ...
  postToProducts: (file?: FileList | null) => void;
}) => {
      ...
      <div className=" bg-white relative p-6 rounded-md max-h-[calc(100vh-20px)] overflow-scroll">
        ...
        >
          <span
            ...
            className="absolute top-2 right-2 px-3  pb-1 rounded-md cursor-pointer text-xl  text-purple-800 border border-purple-800 "
          >
            x
          </span>
          <div className="flex flex-col gap-2 w-full h-fit">
            ...
            <div className="p-4 bg-purple-900 flex flex-col  text-white rounded-md">
              ...
              <p>
                4. Track Your Orders in the orders page at{" "}
                <Link href={"/account/orders"} className="font-bold underline">
                  Orders
                </Link>
              </p>
            </div>
          ...
          <div className="flex flex-col gap-2 w-full">
            ...
            <div className="p-4 bg-purple-900 flex flex-col w-full  text-white rounded-md">
              <p>Account Number: 2007412032</p>
              <p>Account Name: CLASSY CHOICE VARIETIES STORES</p>
              <p>Bank Name: FCMB</p>
            </div>
          </div>
          <div className="w-full">
            <label className="text-purple-900 font-bold mb-2">
              Upload Payment Proof:
            </label>
            <input
              className="w-full bg-purple-800 w-6 h-32 bg-opacity-10 cursor-pointer hidden"
              id="file-input"
              type="file"
              accept="image/*"
            ...
            <label
              htmlFor="file-input"
              className=" mt-2 cursor-pointer block w-full bg-purple-900 px-4 py-2 text-center text-white rounded-md"
            >
              Choose File
            </label>
          </div>
          {file && (
            <div className="relative border border-purple-800 rounded-md">
              <span
